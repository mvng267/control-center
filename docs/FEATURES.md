...
```
321 testid trong mã
109 chưa test nào chạm tới  (đầu đợt: 205)
```

Đợt này lấp 96 cái, ưu tiên thứ dùng thật hàng ngày: chọn nhiều, menu ⋯ mỗi dòng,
...
109 còn lại vẫn là nợ. Selector gãy ở đó thì không gì báo cả.
